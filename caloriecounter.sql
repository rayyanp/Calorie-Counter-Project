...
INSERT INTO `users` (`uid`, `username`, `password`, `firstname`, `lastname`, `email`, `age`, `weight`, `feet`, `inches`) VALUES
(1, 'admin', 'admin1', NULL, NULL, 'admin@example.com',NULL, NULL, NULL, NULL),
(2, 'mentor', 'mentor1',NULL, NULL, 'mentor@example.com',NULL, NULL, NULL, NULL),
(3, 'supplier', 'supplier1',NULL, NULL, 'supplier@example.com',NULL, NULL, NULL, NULL),
(4, 'usertest', 'password', 'Mark', 'Thomas', 'mark.thomas@example.com', 45, 90, 6, 1);
