...
// Sign-in interface
elseif ($_SERVER['REQUEST_URI'] != '/Calorie-Counter-Project-Sonneillon-Overhaul/sign_up.php') {
  include 'verify.php';
            ...
            <form action="home" method="post">
              ...
              <div class="row">
                ...
                <div class="col">
                  <div class="edit">
                    <div class="myInfo">
                      <input class="form-control" type="number" minlength="1" maxlength="3" name="weight" 
              ...
              <div class="row">
                ...
                <div class="col">
                  <div class="edit">
                    <div class="myInfo">
                      <input class="form-control" type="number" minlength="1" maxlength="2" name="feet" 
              ...
              <div class="row">
                ...
                <div class="col">
                  <div class="edit">
                    <div class="myInfo">
                      <input class="form-control" type="number" minlength="1" maxlength="2" name="inches" 
