  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="admin_profile.php">Mentor Home</a>
      </li>
      <li class="nav-item">
      <a class="nav-link" href="admin_view_data.php">View Data</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="admin_experience.php">Experience</a>
      </li>
      <li class="nav-item">
